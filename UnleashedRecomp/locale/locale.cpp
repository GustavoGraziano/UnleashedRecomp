...
std::unordered_map<std::string_view, std::unordered_map<ELanguage, std::string>> g_locale =
{
    ...
    },
    {
        ...
        "Options_Desc_WindowSize",
        {
			...
			{ ELanguage::Portuguese, "Ajusta o tamanho da janela do jogo no modo de janela." }
        }
    },
    {
    ...
    },
    {
        ...
        "Options_Desc_NotAvailableFullscreen",
        {
			...
			{ ELanguage::Portuguese, "Esta opção não está disponível no modo de tela cheia." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableWindowed",
        {
			...
			{ ELanguage::Portuguese, "Esta opção não está disponível no modo de janela." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableHardware",
        {
			...
			{ ELanguage::Portuguese, "Esta opção não está disponível com a sua configuração atual de hardware." }
        }
    },
    {
    ...
    },
    {
        ...
        "Installer_Page_SelectLanguage",
        {
			...
			{ ELanguage::Portuguese, "Por favor, selecione um idioma." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_Introduction",
        {
			...
			{ ELanguage::Portuguese, "Bem-vindo ao\nUnleashed Recompiled!\n\nVocê precisará de uma cópia de\nSonic Unleashed de Xbox 360 para continuar com a instalação." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_SelectGameAndUpdate",
        {
			...
			{ ELanguage::Portuguese, "Adicione as fontes para o jogo e sua atualização." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_SelectDLC",
        {
			...
			{ ELanguage::Portuguese, "Adicione as fontes para as DLCs." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
    ...
    },
    {
        ...
        "Installer_Page_Installing",
        {
			...
			{ ELanguage::Portuguese, "Por favor, aguarde enquanto o conteúdo está sendo instalado..." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
    ...
    },
    {
        ...
        "Installer_Message_FilePickerTutorial",
        {
			...
			{ ELanguage::Portuguese, "Selecione uma cópia digital com\no conteúdo do jogo.\n\nEstes arquivos podem ser obtidos\ndo disco rígido do seu Xbox 360\nseguindo as instruções na\npágina do GitHub.\n\nPara escolher uma pasta com os\narquivos extraídos e não modificados,\nuse a opção \"Adicionar Pasta\"." }
        }
    },
    {
        ...
        "Installer_Message_FolderPickerTutorial",
        {
			...
			{ ELanguage::Portuguese, "Selecione uma pasta que contenha os\narquivos não modificados que foram\nextraídos do jogo.\n\nEstes arquivos podem ser obtidos\ndo disco rígido do seu Xbox 360\nseguindo as instruções na\npágina do GitHub.\n\nPara escolher uma cópia digital,\nuse a opção \"Adicionar Arquivos\"." }
        }
    },
    {
    ...
    },
    {
        ...
        "Installer_Message_DLCWarning",
        {
			...
			{ ELanguage::Portuguese, "É altamente recomendável\nque você instale todas as\nDLCs, pois elas incluem\ntexturas de iluminação de alta\nqualidade para o jogo base.\n\nTem certeza que deseja\npular esta etapa?" }
        }
    },
    {
        ...
        "Installer_Message_TitleMissingDLC",
        {
			...
			{ ELanguage::Portuguese, "Isto reiniciará o jogo para\npermitir a instalação de qualquer\nDLC que esteja faltando.\n\nA instalação de DLCs melhorará a\nqualidade da iluminação em todo o jogo.\n\nGostaria de instalar o conteúdo\nque falta?" }
        }
    },
    {
        ...
        "Installer_Message_Title",
        {
			...
			{ ELanguage::Portuguese, "Isto reinicia o jogo para\npermitir a instalação de qualquer\nDLC que possa estar faltando.\n\nAtualmente, não falta\nnenhuma DLC para você.\n\nGostaria de prosseguir\nmesmo assim?" }
        }
    },
    {
        ...
        "Installer_Message_Quit",
        {
			...
			{ ELanguage::Portuguese, "Tem certeza que deseja sair?" }
        }
    },
    {
        ...
        "Installer_Message_Cancel",
        {
			...
			{ ELanguage::Portuguese, "Tem certeza que deseja cancelar a instalação?" }
        }
    },
    {
    ...
    },
    {
        ...
        "Title_Message_UpdateAvailable",
        {
			...
			{ ELanguage::Portuguese, "Uma atualização está disponível!\n\nGostaria de visitar a página\nde lançamentos para baixá-la?" }
        }
    },
    {
        "Video_BackendError",
    ...
    },
    {
        "System_Win32_MissingDLLs",
        {
			...
			{ ELanguage::Portuguese, "O módulo \"%s\" não pôde ser encontrado.\n\nPor favor, certifique-se de que:\n\n- Você extraiu esta cópia de Unleashed Recompiled completamente e não apenas o arquivo *.exe.\n- Você não está executando o Unleashed Recompiled de um arquivo *.zip." }
        }
    },
    {
        "System_MemoryAllocationFailed",
        {
			...
			{ ELanguage::Portuguese, "Falha ao alocar memória para o jogo.\n\nPor favor, certifique-se de que:\n\n- Você atende aos requisitos mínimos do sistema (8 GB).\n- O seu arquivo de paginação está configurado com pelo menos 4-8 GB de memória virtual." }
        }
    },
    {
    ...
    },
    {
        "Common_Reset",
        {
			...
			{ ELanguage::Portuguese, "Restaurar" }
        }
    },
    {
        "Common_Switch",
